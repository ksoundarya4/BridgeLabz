...
public class TicTacToe {
	 ...
	 */
	public boolean isWonByRows() {
		for (int rows = 0; rows < ROWS; rows++) {
			if (!board[rows][0].matches(NOOUTPUT) && board[rows][0].equals(board[rows][1])
					&& board[rows][1].equals(board[rows][2]))
				return true;
		}
		return false;
	}
	 ...
	 */
	public boolean isWonByDiagonals() {
		if (isWonByLeftDiagonal())
			return true;

		if (isWonByRigthDiagonal())
			return true;
	...
	/**
	 * Checks if board has same inputs at cell (2,0),(1,1),(0,2)
	 * 
	 * @return true if every cell in right diagonal contains same input
	 */
	public boolean isWonByRigthDiagonal() {
	...
	/**
	 * Checks if board has same inputs at cell (0,0),(1,1),(2,2)
	 * 
	 * @return true if every cell in left diagonal contains same input
	 */
	public boolean isWonByLeftDiagonal() {
	 ...
	 */
	public boolean isWonByColums() {
		for (int col = 0; col < COLMS; col++) {
			if (!board[0][col].matches(NOOUTPUT) && board[0][col].equals(board[1][col])
	...
	/**
	 * Function to set player1 takes random cell that is row and col Mark 'O' if
	 * that cell is empty
	 */
	public void player1() {
	...
	/**
	 * Function to set Player2 takes user inputs for cell i.e. rows and colms Mark
	 * 'X' if that cell is empty
	 */
	public void player2() {
